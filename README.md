...
## Usage
Run the code using `go run ./[category]/[quest_name]` from terminal. Enter your private testnet key obtained from the quest and your quest will be automatically completed.
